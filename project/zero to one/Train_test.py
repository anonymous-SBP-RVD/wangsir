...
file_path = "GPT-Moudel/the-verdict.txt"
...
if __name__ == "__main__":
    ...
    model = GPTModel(GPT_CONFIG_124M)  # Initialize model
    model.to(device)  # Move model to device

    optimizer = torch.optim.AdamW(model.parameters(), lr=0.0004, weight_decay=0.1)  # Optimizer

    start_context = "Every effort moves you closer to your goal."
    num_epochs = 10
